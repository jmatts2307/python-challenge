...
#I had to put the literal path as 
file_to_load = os.path.join("/Users/jesusmatajr/Desktop/python-challenge/PyPoll/Resources/election_data.csv")  # Input file path
file_to_output = os.path.join("/Users/jesusmatajr/Desktop/python-challenge/PyPoll/analysis/election_analysis.txt")  # Output file path
